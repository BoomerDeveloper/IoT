...
<head>
  ...
  <h1 style="text-align:center; color:red;">Soham Chowdhury 19EE10075</h1>
  <h3 style="text-align:center;">Sensor data list</h3>
  <style>
  canvas{
  ...
  #dataTable tr:nth-child(even){background-color: #00FFFF;}
